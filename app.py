    ...
    if provider == "CHS":
        ...
        if _ldc_snaps:
            ...
            grains = ["Corn"]
                       ...
                       "Absolute Energy", "Fox River Valley Energy", "Heron Lake BioEnergy", "Glacial Lakes", "Homeland Energy", "KAAPA", "Little Sioux", "Siouxland Energy", "Siouxland Ethanol", "Elite Octane", "Plymouth Energy", "INCO"):
        ...
        _ag_cli   = ({"Star of West": "--sotw-only", "Mennel": "--mennel-only",
                      ...
                      "Plymouth Energy": "--agmd-only"}.get(provider)
