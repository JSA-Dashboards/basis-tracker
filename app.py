...
with tab_bids:
    ...
    if provider == "CHS":
        ...
        _ag_cli   = ({"Star of West": "--sotw-only", "Mennel": "--mennel-only",
                      ...
                      "NuGen Energy": "--agmd-only",
                      "Central Farmers Co-op": "--agmd-only",
                      "Hopkinsville Elevator": "--hec-only",
                      "Georges": "--georges-only",
                      "MNSP": "--cihedging-only"}.get(provider)
