    ...
    if provider == "CHS":
        ...
        if _ldc_snaps:
            ...
            grains = ["Corn"]
                       ...
                       "Absolute Energy", "Fox River Valley Energy", "INCO"):
        ...
        _ag_cli   = ({"Star of West": "--sotw-only", "Mennel": "--mennel-only",
                      ...
                      "Fox River Valley Energy": "--vistacomm-only"}.get(provider)
