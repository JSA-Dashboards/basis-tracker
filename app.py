...
with tab_bids:
    ...
    if provider == "CHS":
        ...
        _ag_cli   = ({"Star of West": "--sotw-only", "Mennel": "--mennel-only",
                      ...
                      "FS Grain": "--agmd-only"}.get(provider)
