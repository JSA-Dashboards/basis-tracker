...
with tab_bids:
    ...
    if provider == "CHS":
        ...
        _ag_cli   = ({"Star of West": "--sotw-only", "Mennel": "--mennel-only",
                      ...
                      "Farm Service Elevator": "--fse-only"}.get(provider)
